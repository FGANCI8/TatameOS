...
<span className="bg-[#FF1A1A] text-white px-2 py-1 font-['Lexend'] font-bold text-[10px] uppercase tracking-widest mb-2 inline-block">Nível Avançado</span>
...
<section>
<h3 className="font-['Lexend'] font-black uppercase tracking-widest text-brand-red text-sm mb-8 border-l-4 border-brand-red/20 pl-4">Passo a Passo Detalhado</h3>
<div className="space-y-0">
{/*  Step 1  */}
<div className="flex gap-6 group">
<div className="flex flex-col items-center">
<div className="w-10 h-10 bg-zinc-800/80 flex items-center justify-center text-zinc-100 font-['Lexend'] font-black text-xl">01</div>
<div className="w-px h-full bg-zinc-800/80 group-last:bg-transparent mt-2"></div>
</div>
<div className="pb-10">
<h4 className="font-['Lexend'] font-bold text-lg text-white uppercase mb-2">Abertura de Guarda e Domínio</h4>
<p className="text-zinc-500 leading-relaxed font-body">Inicie controlando a gola e a manga do oponente. Use o quadril para criar ângulo e force a abertura da base dele com um movimento explosivo de fuga de quadril para o lado oposto ao braço dominado.</p>
</div>
</div>
{/*  Step 2  */}
<div className="flex gap-6 group">
<div className="flex flex-col items-center">
<div className="w-10 h-10 bg-zinc-800/80 flex items-center justify-center text-zinc-100 font-['Lexend'] font-black text-xl">02</div>
<div className="w-px h-full bg-zinc-800/80 group-last:bg-transparent mt-2"></div>
</div>
<div className="pb-10">
<h4 className="font-['Lexend'] font-bold text-lg text-white uppercase mb-2">Isolamento do Membro</h4>
<p className="text-zinc-500 leading-relaxed font-body">Transpasse sua perna por cima do ombro do oponente enquanto mantém a pressão do peito. O braço dele deve ficar preso entre seu pescoço e sua coxa, garantindo que o cotovelo dele não retorne ao solo.</p>
</div>
</div>
{/*  Step 3  */}
<div className="flex gap-6 group">
<div className="flex flex-col items-center">
<div className="w-10 h-10 bg-zinc-800/80 flex items-center justify-center text-zinc-100 font-['Lexend'] font-black text-xl">03</div>
...
<p className="text-zinc-500 leading-relaxed font-body">Feche o cadeado com as pernas ou faça a pegada 'mão com mão' atrás da cabeça. Expanda o tórax e comprima os adutores simultaneamente para interromper o fluxo sanguíneo lateral.</p>
</div>
</div>
</div>
</section>
...
<span className="material-symbols-outlined text-brand-red shrink-0" data-icon="dangerous">dangerous</span>
<span className="text-zinc-400 font-body text-sm">Deixar espaço entre o seu quadril e o ombro do oponente, permitindo que ele escape o braço.</span>
</li>
<li className="flex items-start gap-4">
<span className="material-symbols-outlined text-brand-red shrink-0" data-icon="dangerous">dangerous</span>
<span className="text-zinc-400 font-body text-sm">Não flexionar os pés (dorsiflexão) ao fechar o ajuste, perdendo potência na compressão.</span>
</li>
<li className="flex items-start gap-4">
<span className="material-symbols-outlined text-brand-red shrink-0" data-icon="dangerous">dangerous</span>
<span className="text-zinc-400 font-body text-sm">Esquecer de manter o controle da gola oposta durante a transição inicial.</span>
</li>
</ul>
</section>
</div>
...
<p className="text-zinc-500 italic leading-relaxed font-body text-sm mb-4">
...
<div className="flex items-center gap-2 text-zinc-300 font-['Lexend'] font-bold text-[10px] uppercase tracking-widest">
...
<div className="bg-zinc-950/60 p-4 flex flex-col items-center justify-center text-center">
<span className="text-zinc-500 font-['Lexend'] font-bold text-[10px] uppercase tracking-widest mb-1">Dificuldade</span>
<span className="text-white font-['Lexend'] font-black text-xl uppercase">8/10</span>
</div>
<div className="bg-zinc-950/60 p-4 flex flex-col items-center justify-center text-center">
<span className="text-zinc-500 font-['Lexend'] font-bold text-[10px] uppercase tracking-widest mb-1">Tipo</span>
<span className="text-white font-['Lexend'] font-black text-xl uppercase">Finalização</span>
</div>
<div className="bg-zinc-950/60 p-4 flex flex-col items-center justify-center text-center">
<span className="text-zinc-500 font-['Lexend'] font-bold text-[10px] uppercase tracking-widest mb-1">Repetições</span>
<span className="text-white font-['Lexend'] font-black text-xl uppercase">20x</span>
</div>
<div className="bg-zinc-950/60 p-4 flex flex-col items-center justify-center text-center">
<span className="text-zinc-500 font-['Lexend'] font-bold text-[10px] uppercase tracking-widest mb-1">Calorias Est.</span>
<span className="text-white font-['Lexend'] font-black text-xl uppercase">120kcal</span>
</div>
</div>
{/*  CTA  */}
<button className="w-full bg-brand-red/10 hover:bg-brand-red/20 text-white py-5 px-6 font-['Lexend'] font-black uppercase tracking-widest text-sm transition-colors active:scale-[0.98] duration-100 flex items-center justify-center gap-3">
