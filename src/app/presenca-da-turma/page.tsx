...
<div className="rounded-[28px] border border-zinc-800/80 bg-zinc-900/80 p-6 md:p-8 space-y-1">
...
<img className="w-full h-full object-cover" alt="Portrait of a young athletic man, sweat on face, neutral background, intense look" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAQot8SL3Q9gyTgg7w3_D2cZnBrfsGDshsOURcZTtTkkCHLCTxL6hxyAHZpqJvCyqbgSnoG5VcLxENaHOOJa2RUdaUI2aWqyrh2g1u6AyJxia3TzRNlUIJLVKDQbGZ3io88kgVKZwU0BnufEUTu-MbE__DtXWeKKyOyz1cc9DDSrNsY4gjYBxQoZxQSGI2SffjZOrgVqDAdwxA2DuT1jEC9OY_iyVZ8wZzxXguOFKl412pCOmfDxUA4ZAYrRLkWCori9JaHT38AnhpQ"/>
</div>
<div>
...
<div className="flex items-center gap-4">
<div className="w-14 h-14 bg-zinc-800/80">
<img className="w-full h-full object-cover" alt="Portrait of a male martial artist, sharp jawline, cinematic side lighting, black background" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA_qVTIoAgbQWlyoHKbxlGSJ1uHzpq0d6brzwSNAaMX3tKiiAH0jrXtMCbOqWEBihJ4lYpMYMS4wtFkRPO2E7-juJ5eoyzv4ZRsokdj1kx7A7yb_kRn17LIDpN8bWm9NYEHAzXPojSXsicwzPzDwg3OxygVcA14XGJSgbLktorLrXChACoiFuubNR4Ah4Swgh5TClcQLe1NR_zFnPJfgEg1Apyw07cMV2LUFUULZ2Cy-saZgj1hA1PXAkWzqrIL7koAM8Nwuwm1_ZfL"/>
</div>
<div>
