...
<div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-l-4 border-brand-red/20 pl-6">
<div>
<p className="font-label text-xs font-black uppercase tracking-[0.3em] text-zinc-400 mb-2">COMPETITIVE EVOLUTION</p>
<h2 className="font-headline text-5xl md:text-7xl font-black uppercase tracking-tighter leading-none">THE KINETIC<br/><span className="text-brand-red">MONOLITH</span></h2>
</div>
<div className="flex gap-12">
<div className="flex flex-col">
<span className="font-headline text-4xl font-black italic">84%</span>
<span className="font-label text-[10px] font-bold uppercase text-zinc-500">CONSISTENCY SCORE</span>
</div>
<div className="flex flex-col">
<span className="font-headline text-4xl font-black italic text-brand-red">+12</span>
<span className="font-label text-[10px] font-bold uppercase text-zinc-500">TECHNICAL PEAK</span>
</div>
</div>
</div>
</section>
{/*  Dynamic Timeline Grid  */}
<section className="grid grid-cols-1 lg:grid-cols-12 gap-1 bg-zinc-950/60 p-1">
{/*  Timeline Sidebar (Year/Stage)  */}
<div className="lg:col-span-1 flex lg:flex-col justify-around py-8 bg-zinc-800/80 border-r-0 lg:border-r border-background">
<span className="font-headline text-xl font-black text-brand-red transform lg:-rotate-90">2024</span>
<span className="font-headline text-xl font-black text-zinc-500 transform lg:-rotate-90 opacity-40">2023</span>
<span className="font-headline text-xl font-black text-zinc-500 transform lg:-rotate-90 opacity-20">2022</span>
</div>
...
<div className="grid grid-cols-3 gap-4 border-t border-zinc-800/20 pt-6">
<div>
<p className="font-label text-[10px] font-black text-zinc-400 uppercase">PRECISION</p>
<p className="font-headline text-xl font-black">9.4</p>
</div>
<div>
<p className="font-label text-[10px] font-black text-zinc-400 uppercase">STAMINA</p>
<p className="font-headline text-xl font-black">HIGH</p>
</div>
<div>
<p className="font-label text-[10px] font-black text-zinc-400 uppercase">RANK</p>
<p className="font-headline text-xl font-black text-brand-red">#1</p>
</div>
</div>
</div>
<div className="md:col-span-1 bg-zinc-800/80 p-6 flex flex-col justify-center items-center text-center">
<span className="material-symbols-outlined text-5xl text-brand-red mb-4" data-icon="military_tech" style={{ /* font-variation-settings: 'FILL' 1; */ }}>military_tech</span>
<p className="font-headline text-3xl font-black italic uppercase leading-none mb-1">GOLD<br/>MEDAL</p>
<p className="font-label text-[10px] tracking-widest text-zinc-400 uppercase">PRO DIVISION</p>
</div>
</div>
{/*  Timeline Node 02: Consistency Growth  */}
<div className="grid grid-cols-1 md:grid-cols-4 bg-zinc-900/80 gap-1 p-1">
<div className="md:col-span-1 bg-zinc-800/80 p-6 flex flex-col justify-between border-l-8 border-zinc-800">
<p className="font-headline text-4xl font-black text-zinc-300/30 italic">02</p>
<div>
<p className="font-label text-[10px] font-black text-zinc-300 uppercase tracking-widest mb-1">PHASE: REFINEMENT</p>
...
<p className="font-body text-sm text-zinc-400 italic">Identification of counter-striking gaps. Implementation of the 'monolith' defensive stance.</p>
</div>
...
<div className="relative w-full h-12 bg-zinc-950 overflow-hidden">
<div className="absolute inset-y-0 left-0 bg-gradient-to-r from-zinc-800 to-zinc-100 w-3/4 flex items-center px-4">
<span className="font-label text-[10px] font-black text-zinc-100 uppercase tracking-widest">STABILITY REACHED 75%</span>
</div>
</div>
</div>
</div>
...
<p className="font-label text-[10px] text-zinc-400">ROOKIE LEAGUE</p>
</div>
</div>
</div>
</section>
...
<span className="font-headline text-3xl font-black text-brand-red">%</span>
</div>
<div className="bg-zinc-800/80 h-1 w-full">
...
<span className="font-headline text-3xl font-black text-zinc-300">kN</span>
</div>
...
<div className="h-4 w-1/5 bg-brand-red/10"></div>
<div className="h-4 w-1/5 bg-brand-red/10"></div>
<div className="h-4 w-1/5 bg-brand-red/10"></div>
<div className="h-4 w-1/5 bg-brand-red/10"></div>
<div className="h-4 w-1/5 bg-brand-red/10 opacity-30"></div>
</div>
</div>
</div>
</section>
