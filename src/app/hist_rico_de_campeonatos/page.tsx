...
<button className="w-10 h-10 flex items-center justify-center hover:bg-[#1C1B1B] transition-colors active:scale-95 duration-75">
<span className="material-symbols-outlined text-[#E70000]" data-icon="account_circle">account_circle</span>
</button>
</header>
<main className="pt-24 pb-32 px-4 max-w-5xl mx-auto space-y-12">
{/*  Hero Summary Section  */}
<section className="grid grid-cols-1 md:grid-cols-3 gap-1">
<div className="bg-surface-container-low p-8 flex flex-col justify-end min-h-[160px]">
<span className="font-headline text-label-sm uppercase tracking-widest text-tertiary-fixed-dim mb-2">VITÓRIAS TOTAIS</span>
<div className="flex items-baseline gap-2">
<span className="font-headline text-6xl font-black text-on-surface">42</span>
<span className="text-primary-container font-black text-xl">/ 50</span>
</div>
</div>
<div className="bg-surface-container-high p-8 flex flex-col justify-end min-h-[160px]">
<span className="font-headline text-label-sm uppercase tracking-widest text-tertiary-fixed-dim mb-2">TAXA DE FINALIZAÇÃO</span>
<div className="flex items-baseline gap-2">
<span className="font-headline text-6xl font-black text-on-surface">68</span>
<span className="text-on-surface font-black text-xl">%</span>
</div>
</div>
<div className="kinetic-gradient p-8 flex flex-col justify-end min-h-[160px]">
<span className="font-headline text-label-sm uppercase tracking-widest text-on-primary-container/80 mb-2">RANKING ATUAL</span>
<div className="flex items-baseline gap-2">
<span className="font-headline text-6xl font-black text-on-primary-container">#12</span>
<span className="text-on-primary-container font-black text-xl">ESTADUAL</span>
</div>
</div>
</section>
...
<span className="material-symbols-outlined text-tertiary cursor-pointer" data-icon="filter_list">filter_list</span>
<span className="font-label text-xs font-bold uppercase tracking-widest text-tertiary">FILTRAR POR ANO</span>
</div>
</div>
{/*  Tournament Card 1: Gold  */}
<div className="bg-surface-container-low group flex flex-col md:flex-row items-stretch overflow-hidden">
<div className="relative w-full md:w-48 h-48 md:h-auto bg-surface-container-highest flex-shrink-0">
...
<span className="font-label text-[10px] font-black uppercase tracking-[0.2em] text-primary-container">15 MAR 2024</span>
<h3 className="font-headline text-3xl font-black uppercase leading-none text-on-surface">IBJJF CURITIBA OPEN</h3>
<div className="flex flex-wrap gap-2 pt-2">
<span className="bg-surface-container-highest px-3 py-1 font-label text-[10px] font-bold tracking-widest uppercase">FAIXA ROXA</span>
<span className="bg-surface-container-highest px-3 py-1 font-label text-[10px] font-bold tracking-widest uppercase">PESO LEVE (-76KG)</span>
</div>
</div>
<div className="flex flex-col justify-between items-end text-right">
<div className="space-y-1">
<p className="font-label text-[10px] font-bold uppercase tracking-widest text-tertiary">RESULTADO FINAL</p>
<p className="font-headline text-4xl font-black text-on-surface">OURO</p>
</div>
<button className="bg-primary-container text-on-primary-container px-6 py-3 font-label text-[10px] font-black tracking-[0.2em] uppercase hover:bg-inverse-primary transition-colors flex items-center gap-2 group-hover:translate-x-1 duration-200">
...
<div className="p-8 flex-grow grid grid-cols-1 md:grid-cols-2 gap-8">
<div className="space-y-4">
<span className="font-label text-[10px] font-black uppercase tracking-[0.2em] text-primary-container">02 FEV 2024</span>
<h3 className="font-headline text-3xl font-black uppercase leading-none text-on-surface">CAMPEONATO PAULISTA</h3>
<div className="flex flex-wrap gap-2 pt-2">
<span className="bg-surface-container-highest px-3 py-1 font-label text-[10px] font-bold tracking-widest uppercase">FAIXA ROXA</span>
<span className="bg-surface-container-highest px-3 py-1 font-label text-[10px] font-bold tracking-widest uppercase">ABSOLUTO</span>
</div>
</div>
<div className="flex flex-col justify-between items-end text-right">
<div className="space-y-1">
<p className="font-label text-[10px] font-bold uppercase tracking-widest text-tertiary">RESULTADO FINAL</p>
<p className="font-headline text-4xl font-black text-on-surface">PRATA</p>
</div>
<button className="border border-outline-variant/30 text-on-surface px-6 py-3 font-label text-[10px] font-black tracking-[0.2em] uppercase hover:bg-surface-container-highest transition-colors flex items-center gap-2 group-hover:translate-x-1 duration-200">
                            DETALHES DAS LUTAS <span className="material-symbols-outlined text-sm" data-icon="arrow_forward">arrow_forward</span>
</button>
</div>
</div>
...
<div className="p-8 flex-grow grid grid-cols-1 md:grid-cols-2 gap-8">
<div className="space-y-4">
<span className="font-label text-[10px] font-black uppercase tracking-[0.2em] text-primary-container">12 DEZ 2023</span>
<h3 className="font-headline text-3xl font-black uppercase leading-none text-on-surface">COPA INTERNACIONAL</h3>
<div className="flex flex-wrap gap-2 pt-2">
<span className="bg-surface-container-highest px-3 py-1 font-label text-[10px] font-bold tracking-widest uppercase">FAIXA AZUL</span>
<span className="bg-surface-container-highest px-3 py-1 font-label text-[10px] font-bold tracking-widest uppercase">PESO LEVE (-76KG)</span>
</div>
</div>
<div className="flex flex-col justify-between items-end text-right">
<div className="space-y-1">
<p className="font-label text-[10px] font-bold uppercase tracking-widest text-tertiary">RESULTADO FINAL</p>
<p className="font-headline text-4xl font-black text-on-surface">BRONZE</p>
</div>
<button className="border border-outline-variant/30 text-on-surface px-6 py-3 font-label text-[10px] font-black tracking-[0.2em] uppercase hover:bg-surface-container-highest transition-colors flex items-center gap-2 group-hover:translate-x-1 duration-200">
                            DETALHES DAS LUTAS <span className="material-symbols-outlined text-sm" data-icon="arrow_forward">arrow_forward</span>
</button>
...
<div className="bg-surface-container-low group flex flex-col md:flex-row items-stretch overflow-hidden opacity-80 grayscale">
<div className="relative w-full md:w-48 h-48 md:h-auto bg-surface-container-highest flex-shrink-0">
...
<div className="absolute inset-0 bg-gradient-to-t from-surface-container-low via-transparent to-transparent"></div>
<div className="absolute top-4 left-4">
<span className="material-symbols-outlined text-5xl text-tertiary-fixed-dim drop-shadow-lg" data-icon="emoji_events">emoji_events</span>
</div>
</div>
<div className="p-8 flex-grow grid grid-cols-1 md:grid-cols-2 gap-8">
<div className="space-y-4">
<span className="font-label text-[10px] font-black uppercase tracking-[0.2em] text-tertiary">20 OUT 2023</span>
<h3 className="font-headline text-3xl font-black uppercase leading-none text-on-surface">GRAND PRIX NOGI</h3>
<div className="flex flex-wrap gap-2 pt-2">
<span className="bg-surface-container-highest px-3 py-1 font-label text-[10px] font-bold tracking-widest uppercase">FAIXA AZUL</span>
<span className="bg-surface-container-highest px-3 py-1 font-label text-[10px] font-bold tracking-widest uppercase">PESO LEVE (-76KG)</span>
</div>
...
<div className="space-y-1">
<p className="font-label text-[10px] font-bold uppercase tracking-widest text-tertiary">RESULTADO FINAL</p>
<p className="font-headline text-2xl font-black text-on-surface/60">PARTICIPAÇÃO</p>
</div>
<button className="border border-outline-variant/10 text-on-surface/40 px-6 py-3 font-label text-[10px] font-black tracking-[0.2em] uppercase cursor-not-allowed">
...
<div className="bg-surface-container p-6 space-y-4 border-l-4 border-[#FFD700]">
...
<p className="font-label text-[10px] font-bold uppercase tracking-widest text-tertiary">OUROS</p>
</div>
</div>
<div className="bg-surface-container p-6 space-y-4 border-l-4 border-[#C0C0C0]">
...
<p className="font-label text-[10px] font-bold uppercase tracking-widest text-tertiary">PRATAS</p>
</div>
</div>
<div className="bg-surface-container p-6 space-y-4 border-l-4 border-[#CD7F32]">
...
<p className="font-label text-[10px] font-bold uppercase tracking-widest text-tertiary">BRONZES</p>
</div>
</div>
<div className="bg-surface-container p-6 space-y-4 border-l-4 border-primary-container">
<span className="material-symbols-outlined text-primary-container text-4xl" data-icon="show_chart">show_chart</span>
<div>
<p className="font-headline text-4xl font-black">82%</p>
<p className="font-label text-[10px] font-bold uppercase tracking-widest text-tertiary">Frequência Pódio</p>
</div>
</div>
</div>
</section>
...
<a className="flex flex-col items-center justify-center text-[#E70000] scale-110 transition-transform hover:text-white active:bg-[#E70000]/10" href="#">
