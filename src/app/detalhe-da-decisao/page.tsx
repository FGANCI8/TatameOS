...
{/*  Contexto  */}
<div className="rounded-[28px] border border-zinc-800/80 bg-zinc-900/80 p-6 md:p-8 md:col-span-2 space-y-4">
...
{/*  O que foi feito  */}
<div className="rounded-[28px] border border-zinc-800/80 bg-zinc-900/80 p-6 md:p-8 space-y-4">
<div className="flex items-center gap-2">
...
<img className="w-full h-full object-contain mix-blend-lighten" alt="minimalist white line tactical diagram of a jiu-jitsu position on a dark chalkboard background with red strategy arrows" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA-3LH_pIB1KnuhSwmv4LxcjzQekp7WcTT-ZaezF2JAOwq3h-HSQe7vu9uyrR3Cirwv9r_OR9IgLstFvtyEU7Ka5dwVEgdnTkuj2g8fKsZHkQQtkWAhFwbzTbfIoCxSqAj-DXSuZ9Ph4ZdUXCwHtm1G0_YwcWqJdrRC2K3V0gIkAL8gaeW91FbOvlIVuvl-c-rzZKORMTqWcK1oyghBcSmm6YgaZPS5tjtqMrdZ5zCbW8ivQ6a47ZnUg8wwZwTKsS6Uqx8toGBcJwsH"/>
</div>
</div>
</section>
</main>
