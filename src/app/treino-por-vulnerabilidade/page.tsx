...
<img className="w-full h-full object-cover" alt="Two athletes grappling on mats, focusing on a takedown defense posture, high contrast black and white style" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBnuQxj7ow8ZCpLX2xtP9ePjmNH-FbTtdX21ncYocgYXaKu0Fj19g7Nlk66_3qZe83L0FbQq4zoiXiQngaa9CWKrf7zN9YnnDZ7uK464gbhV2obCZpWDP_HqNDiVtigExVV0JHn5jUVzj-ENvmu9NT7-B_2nT9SoQXRIReh-0DV7sXsmmAytT05rh2xZ_JWG0y8GLAdqpPBRXSMSM2U_YYZKEM6jf9TOgQ72y-8iXvLh1TtEXC3JF1bXUepJeMjCaj-lGIKPF-tHnA8"/>
</div>
...
{/*  Retenção de Guarda  */}
<article className="md:col-span-4 rounded-[28px] border border-zinc-800/80 bg-zinc-900/80 p-6 md:p-8 flex flex-col justify-between h-[400px]">
