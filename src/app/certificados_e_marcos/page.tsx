...
{/*  TopAppBar  */}
<header className="bg-[#131313] dark:bg-black/80 backdrop-blur-xl flex justify-between items-center px-6 py-4 w-full fixed top-0 z-50 bg-[#1C1B1B] border-none">
<div className="flex items-center gap-3">
<div className="w-10 h-10 bg-surface-container-highest flex items-center justify-center overflow-hidden sharp-edge">
<img className="w-full h-full object-cover" data-alt="close up of a professional brazilian jiu jitsu athlete face with intense focus" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAohJPLRM82zSDr_y4tiz3_MLnOuGWBvPde5KTk4-YDwiF46PoYjlwe1ysItj-kBhEc3yZ3c8rMMa-Po-u3lxpLMg7FGtsD4JzfRUuWU-1o7j1W98ANaCY4bU8T-slUxiQ-I8pkPdKDnfx-d9wQfv8GMVIvmoli8g0nLNYEXdMLA5MtWDgd_Xiwr4wTIO21aGHPJinskvUQWftbuQJ7TZSUwWkbTRN4DGxPrMfo1hdjGy8lovueol22LAbbuQABjxkpIzgjVQI7Ph7B"/>
</div>
...
<span className="font-['Inter'] uppercase text-[10px] font-bold tracking-widest text-[#E70000]">CONQUISTAS TÉCNICAS</span>
<h2 className="font-headline text-5xl font-black italic uppercase tracking-tighter">LEGADO KINETIC</h2>
</div>
<div className="bg-surface-container-low px-6 py-4 flex items-center gap-8 sharp-edge">
<div className="text-center">
<p className="text-3xl font-black font-headline">08</p>
<p className="text-[10px] uppercase font-bold text-tertiary-fixed-dim tracking-widest">Certificados</p>
</div>
<div className="w-px h-10 bg-surface-container-highest"></div>
<div className="text-center">
<p className="text-3xl font-black font-headline">12</p>
<p className="text-[10px] uppercase font-bold text-tertiary-fixed-dim tracking-widest">Marcos</p>
</div>
</div>
</div>
{/*  The Performance Streak Component  */}
<div className="bg-surface-container-low p-6 space-y-4 sharp-edge relative overflow-hidden group">
<div className="absolute top-0 right-0 w-32 h-32 bg-primary-container/5 -mr-12 -mt-12 rotate-45 pointer-events-none"></div>
<div className="flex justify-between items-center">
<span className="font-headline font-bold text-sm tracking-widest uppercase italic">Progresso Faixa Roxa</span>
<span className="text-[#E70000] font-black text-lg">72%</span>
</div>
<div className="w-full h-4 bg-surface-container-highest sharp-edge overflow-hidden">
<div className="h-full bg-gradient-to-r from-[#E70000] to-[#C00100] w-[72%] relative">
<div className="absolute inset-0 bg-white/20 animate-pulse"></div>
</div>
</div>
<p className="text-[10px] uppercase font-bold text-tertiary-fixed-dim">Próximo Marco: 150 treinos concluídos (Faltam 12)</p>
</div>
</section>
{/*  Digital Certificates Gallery (Bento-ish Grid)  */}
<section className="space-y-6">
<div className="flex items-center justify-between">
<h3 className="font-headline font-black text-xl italic uppercase tracking-tighter border-l-4 border-[#E70000] pl-4">Galeria de Diplomas</h3>
<button className="text-[10px] uppercase font-bold text-[#E70000] tracking-widest flex items-center gap-2 hover:opacity-80 transition-opacity">
                    VER TODOS <span className="material-symbols-outlined text-xs" data-icon="arrow_forward">arrow_forward</span>
</button>
</div>
<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
{/*  Cert 1 (Large)  */}
<div className="md:col-span-2 bg-surface-container-low group cursor-pointer overflow-hidden sharp-edge flex flex-col md:flex-row h-full">
...
<span className="bg-[#E70000] text-white px-2 py-0.5 text-[10px] font-bold uppercase tracking-widest">OFFICIAL SEMINAR</span>
</div>
</div>
...
<p className="text-sm text-tertiary-fixed-dim leading-relaxed">Mestre Marcus "Buchecha" Almeida. Kinetic HQ, São Paulo.</p>
</div>
<div className="pt-6 flex items-center justify-between border-t border-surface-container-highest">
<span className="text-[10px] font-bold uppercase tracking-widest text-[#E70000]">MAR 2024</span>
<span className="material-symbols-outlined text-tertiary-fixed-dim" data-icon="verified">verified</span>
</div>
</div>
</div>
{/*  Cert 2  */}
<div className="bg-surface-container-low group cursor-pointer overflow-hidden sharp-edge flex flex-col h-full">
...
<div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
<div className="absolute bottom-4 left-4">
<span className="bg-surface-container-highest text-white px-2 py-0.5 text-[10px] font-bold uppercase tracking-widest">WORKSHOP</span>
</div>
</div>
<div className="p-6 space-y-4 flex-1 flex flex-col justify-between">
<h4 className="font-headline font-black text-xl leading-tight uppercase">Técnicas de Finalização Kimura</h4>
<div className="flex items-center justify-between">
<span className="text-[10px] font-bold uppercase tracking-widest text-tertiary-fixed-dim">JAN 2024</span>
<span className="material-symbols-outlined text-tertiary-fixed-dim" data-icon="download">download</span>
</div>
</div>
</div>
{/*  Cert 3  */}
...
<div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
<div className="absolute bottom-4 left-4">
<span className="bg-[#E70000] text-white px-2 py-0.5 text-[10px] font-bold uppercase tracking-widest">RANK UP</span>
</div>
</div>
<div className="p-6 space-y-4 flex-1 flex flex-col justify-between">
<h4 className="font-headline font-black text-xl leading-tight uppercase">Promoção: Faixa Azul 4 Graus</h4>
<div className="flex items-center justify-between">
<span className="text-[10px] font-bold uppercase tracking-widest text-tertiary-fixed-dim">NOV 2023</span>
<span className="material-symbols-outlined text-tertiary-fixed-dim" data-icon="military_tech" style={{ /* font-variation-settings: 'FILL' 1; */ }}>military_tech</span>
</div>
</div>
</div>
...
<p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#E70000]">Conclua o curso de Defesa Pessoal Nível II</p>
</div>
<div className="absolute inset-0 border-2 border-dashed border-surface-container-highest opacity-50"></div>
</div>
</div>
</section>
{/*  Timeline of Major Milestones  */}
<section className="space-y-8">
<h3 className="font-headline font-black text-xl italic uppercase tracking-tighter border-l-4 border-[#E70000] pl-4">Linha do Tempo de Glórias</h3>
<div className="relative ml-4 md:ml-8 border-l-2 border-surface-container-highest space-y-12 pb-8">
{/*  Timeline Item 1  */}
<div className="relative pl-10">
<div className="absolute -left-[11px] top-0 w-5 h-5 bg-[#E70000] border-4 border-[#131313] sharp-edge rotate-45"></div>
<div className="space-y-3">
<div className="flex items-center justify-between">
<span className="text-[10px] font-bold uppercase tracking-widest text-[#E70000]">MAIO 2024</span>
<span className="bg-surface-container-highest text-[10px] font-bold px-2 py-0.5 uppercase tracking-widest">EPIC MILESTONE</span>
</div>
<h4 className="font-headline font-black text-2xl uppercase italic">1 ANO DE KINETIC BJJ</h4>
<div className="bg-surface-container-low p-4 sharp-edge flex items-center gap-4 border-l-4 border-[#E70000]">
<span className="material-symbols-outlined text-3xl text-[#E70000]" data-icon="workspace_premium" style={{ /* font-variation-settings: 'FILL' 1; */ }}>workspace_premium</span>
<div>
<p className="font-bold text-sm uppercase">DEDICAÇÃO INABALÁVEL</p>
<p className="text-xs text-tertiary-fixed-dim">365 dias de evolução, suor e disciplina absoluta no tatame.</p>
</div>
</div>
</div>
</div>
...
<div className="space-y-3">
<div className="flex items-center justify-between">
<span className="text-[10px] font-bold uppercase tracking-widest text-tertiary">FEV 2024</span>
</div>
<h4 className="font-headline font-black text-xl uppercase">100 TREINOS CONCLUÍDOS</h4>
<p className="text-xs text-tertiary-fixed-dim leading-relaxed">A consistência é a mãe da maestria. Você alcançou a marca de 100 sessões de treino de alta intensidade.</p>
</div>
</div>
{/*  Timeline Item 3  */}
<div className="relative pl-10 opacity-60 hover:opacity-100 transition-opacity">
...
<div className="space-y-3">
<div className="flex items-center justify-between">
<span className="text-[10px] font-bold uppercase tracking-widest text-tertiary">DEZ 2023</span>
</div>
...
<div className="absolute -left-[9px] top-0 w-4 h-4 bg-surface-container-highest border-2 border-[#131313] sharp-edge rotate-45"></div>
<div className="space-y-2">
<span className="text-[10px] font-bold uppercase tracking-widest">EM BREVE...</span>
<h4 className="font-headline font-black text-xl uppercase text-surface-container-highest">FAIXA ROXA</h4>
</div>
</div>
</div>
</section>
...
<button className="w-full bg-gradient-to-br from-[#E70000] to-[#C00100] py-6 sharp-edge group relative overflow-hidden transition-all duration-300 active:scale-[0.98]">
...
{/*  BottomNavBar  */}
<nav className="fixed bottom-0 left-0 w-full flex justify-around items-center px-4 pb-4 h-20 bg-[#1C1B1B]/90 dark:bg-[#131313]/95 backdrop-blur-md z-50 border-none">
