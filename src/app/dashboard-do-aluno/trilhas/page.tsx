...
const AlunoTrilhasContent = lazy(() => import('./AlunoTrilhasContent'));

function AlunoTrilhasSkeleton() {
  return (
...
export default function TrilhasAlunoPage() {
  return (
    <main className="mx-auto max-w-7xl space-y-8 px-4 pb-32 pt-24 md:px-6">
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl space-y-3">
            ...
            <p className="max-w-2xl text-sm leading-7 text-zinc-400">
              Veja os módulos publicados para a sua faixa atual e avance no tatame com sequência estruturada.
            </p>
          </div>
      ...
      <Suspense fallback={<AlunoTrilhasSkeleton />}>
        <AlunoTrilhasContent />
      </Suspense>
    </main>
  );
