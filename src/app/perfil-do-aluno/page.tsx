  ...
  return (
    <main className="mt-20 px-6 max-w-5xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="bg-zinc-900 px-4 py-2">
              ...
              <span className="font-headline font-bold text-brand-red uppercase">
                {perfil?.dataCadastro ? new Date(perfil.dataCadastro).getFullYear() : '2024'}
              </span>
            </div>
          </div>
        </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-12">
        ...
        <div className="md:col-span-2 rounded-[28px] border border-zinc-800/80 rounded-[28px] border border-zinc-800/80 bg-zinc-900/80 p-6 md:p-8 md:p-8 flex flex-col justify-between group hover:bg-zinc-900/80 transition-colors border-l border-brand-red/20">
          <span className="font-label text-xs font-bold uppercase tracking-widest text-zinc-400">Tempo de Tatame</span>
          <div className="mt-4 flex items-baseline gap-2">
            <span className="font-headline text-7xl font-black text-zinc-100 group-hover:text-brand-red transition-colors">{perfil?.horasTotais || 0}</span>
            <span className="font-headline text-xl text-zinc-400">HORAS</span>
          </div>
          <div className="mt-6 flex items-center gap-2 text-brand-red">
            <span className="material-symbols-outlined">trending_up</span>
            <span className="font-label text-xs font-bold uppercase tracking-widest">+12% ESTE MÊS</span>
          </div>
        </div>
        {/*  Streak Counter  */}
        <div className="bg-zinc-800/80 p-6 flex flex-col justify-between border-t border-brand-red/30">
          <span className="font-label text-xs font-bold uppercase tracking-widest text-zinc-400">Mocks / Metas</span>
          <div>
            <span className="font-headline text-5xl font-black text-white">14</span>
          ...
          <div className="flex gap-1 mt-4">
            ...
            <div className="w-full h-1 bg-brand-red/10"></div>
            <div className="w-full h-1 bg-brand-red/10"></div>
            <div className="w-full h-1 bg-zinc-900/80"></div>
            <div className="w-full h-1 bg-zinc-900/80"></div>
          </div>
        </div>
        {/*  Ranking (Mock for now)  */}
        <div className="rounded-[28px] border border-zinc-800/80 rounded-[28px] border border-zinc-800/80 bg-zinc-900/80 p-6 md:p-8 md:p-8 flex flex-col justify-between border-r border-white/5">
          <span className="font-label text-xs font-bold uppercase tracking-widest text-zinc-400">Ranking Local</span>
          <div>
            <span className="font-headline text-5xl font-black text-zinc-300">#12</span>
            <p className="font-label text-[10px] text-zinc-400 uppercase mt-1">ESTIMADO</p>
          </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-end">
                  ...
                  <span className="font-headline text-xl font-bold text-zinc-100">
                    {perfil?.horasTotais || 0}<span className="text-zinc-400 text-sm ml-1">/50h</span>
                  </span>
                </div>
                ...
                <div className="h-4 bg-zinc-950 overflow-hidden">
                  <div 
                    ...
                    style={{ width: `${Math.min(((perfil?.horasTotais || 0) / 50) * 100, 100)}%` }}
                  >
